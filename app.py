...
st.markdown(
    ...
    pandas for data handling, and stores fetched results to maintain interactivity across visualizations. 
    Country masks are loaded as GeoJSON files to define spatial boundaries, enabling contextual 
    analysis. The app is designed for humanitarian, academic, and policy users needing timely geospatial insights 
