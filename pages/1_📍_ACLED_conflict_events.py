...
def load_country_dict():
    ...
    return country_dict
acled_names= pd.read_csv('https://raw.githubusercontent.com/oscarbau/streamlit_template/refs/heads/dashboards/data/acled_iso_codes.csv', delimiter=';')
...
def get_conflict(period, iso, iso3):
    ...
    while current_start <= end_date:
        ...
        url = (
            ...
            f'iso={iso}&limit=0&'
            f'event_date={current_start.strftime("%Y-%m-%d")}|{current_end.strftime("%Y-%m-%d")}&'
